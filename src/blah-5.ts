...
// TODO suspiciously like Entitlement
...
const MemberFeature = sequelize.define('MemberFeature', {
  MemberId: {
    type: DataTypes.INTEGER,
    allowNull: false,
    primaryKey: true,
...
const OrganizationFeature = sequelize.define('OrganizationFeature', {
  MemberId: {
    type: DataTypes.INTEGER,
    allowNull: false,
    primaryKey: true,
...
Member.belongsToMany(Feature, {
  through: 'MemberFeature',
});
Feature.belongsToMany(Member, {
  through: 'MemberFeature',
});

Organization.belongsToMany(Feature, {
  through: 'OrganizationFeature',
});
Feature.belongsToMany(Organization, {
  through: 'OrganizationFeature',
});
